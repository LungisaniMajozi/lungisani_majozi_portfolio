    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center border-4 border-w- border-purple-600 rounded-lg"
        }
      >
        <li className="py-6 text-4xl border-b-2 border-purple-600 ">
